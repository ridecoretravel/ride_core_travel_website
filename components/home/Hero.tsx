        ...
        <div className="bg-charcoal/85 backdrop-blur-md border border-white/10 rounded-sm overflow-hidden">
          ...
          {status === 'sent' ? (
            <div className="px-6 py-14 flex flex-col items-center gap-4 text-center">
              ...
              <button
                onClick={() => { setStatus('idle'); setName(''); setEmail(''); setPhone(''); setPickup(''); setDropoff(''); setDate(''); setTime(''); setPassengers('1'); setReturnOn(false); setLuggage(''); setStops(''); setFlightNumber('') }}
